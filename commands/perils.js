...
const perilArray = {
    'values': [
       ...
       {name: 'BANSHEE SCREAM',
        desc: 'A mighty roar akin to a sonic boom crashes through the air. Lesser animal lifeforms (insects, rodents, avians, etc.) within 25 m are instantly killed. All others suffer '+common.dice(3)+' Shock and must make a successful DN 3 Toughness Test or are Staggered.'},
       ...
       {name: 'LIFE DRAIN',
        desc: 'A numbing cold washes out from you, leeching the very life essence of those nearby. Every living creature within 25 m immediately suffers '+common.dice(3)+' Shock and all lesser life forms (plants, avians, insects, etc.) wither and die.'},
       {name: 'VISIONS OF POSSIBILITY',
        desc: 'An awful droning buzz surrounds you, drowning out all speech. The drone penetrates the mind. All creatures with the PSYKER Keyword within 10 m must make a DN 4 Intellect Test. Those who fail are Staggered and suffer '+common.dice(3)+' Shock. Those who succeed gain 1 Wrath.'},
       {name: 'PSYCHIC BACKLASH',
        desc: 'Lurid-pink Warp lightning dances across your flesh. You suffer '+(common.dice(3)+2)+' Shock.'},
       {name: 'THE VEIL THINS',
       ...
       {name: 'WARPTOUCHED AURA',
        desc: 'The mystical energies of the Warp wash over you and infuse the landscape for 25 m in every direction. All creatures in the area suffer '+common.dice(3)+' Shock. In addition, the invisible energies flowing through this area greatly increase the potency of psychic phenomena — 1 Wrath Dice must be added to all Psychic Mastery (Wil) for the remainder of the scene.'},
       {name: 'SURGING WARP ENERGIES',
        desc: 'The air seems to shimmer and distort. All creatures within 25 m of you suffer '+common.dice(6)+' Shock and the GM gains 1 Ruin. For the remainder of the scene, all Wrath Dice rolled as part of a Psychic Mastery Test that don\'t result in a 1 or a 6 must be re-rolled once.'},
       {name: 'UNNATURAL EFFUSIONS',
        desc: 'You vomit foul otherworldly materials uncontrollably, far more than your body could ever produce. You suffer '+common.dice(6)+' Shock and are Restrained for '+common.dice(6)+' Rounds.'},
       {name: 'THE CRAWLING',
        desc: 'You are overcome with the sensation of tiny creatures moving just under your skin. You immediately suffer '+(common.dice(6)+1)+' Shock and must increase the DN of all Tests by 2 for the remainder of the scene.'},
       {name: 'TWISTED FLESH',
        desc: 'The energies of the Warp unleash a corruptive force on your physical form and all creatures within 10m. All affected characters must make a DN 7 Corruption Test. Those who fail gain '+common.dice(3)+' Corruption (instead of just one) and suffer 1 Mortal Wound.'},
       {name: 'GRAVE CHILL',
       ...
       {name: 'WRITHING DISFIGUREMENT',
        desc: 'You are wracked with pain, collapsing to the ground. You suffer '+common.dice(6)+' Shock and gain '+(common.dice(3)+1)+' Corruption. You must roll on the Minor Mutations table (p.288).'},
       {name: 'SPECTRAL GALE',
