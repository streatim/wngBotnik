...
const dict = {
  'knife': {
    ...
    ap: '-',
    rangeShort: 1,
    rangeMedium: 'Thrown: Sx4',
    rangeLong: 'Thrown: Sx4',
    traits: [],
    value: 2,
    rarity: 'Common',
    keywords: ['BLADE', '[ANY]'], 
  ...
  'eviscerator': {
    ...
    value: 3,
    rarity: 'Rare',
    keywords: ['CHAIN', '2-HANDED', 'ADEPTUS ASTARTES', 'ADEPTUS MINISTORUM', 'ADEPTUS SORORITAS'], 
  },  
  'chain fist': {
    name: 'Chain Fist',
    damage: '7',
  ...
  'neural whip': {
    ...
    value: 5,
    rarity: 'Rare',
    keywords: ['EXOTIC', 'CHAOS', 'INQUISITON'], 
  },  
  'shock whip': {
    name: 'Shock Whip',
    damage: '4',
  ...
  'omnissian axe': {
    ...
    value: 6,
    rarity: 'Very Rare',
    keywords: ['POWER FIELD', '2-HANDED', 'IMPERIUM', 'ADEPTUS MECHANICUS'], 
  },  
  'power axe': {
    name: 'Power Axe',
    damage: '5',
    ...
    value: 6,
    rarity: 'Rare',
    keywords: ['POWER FIELD', 'IMPERIUM', 'ADEPTUS MECHANICUS', 'AELDARI'], 
  },  
  'power fist': {
    name: 'Power Fist',
    damage: '5',
  ...
  'hand flamer': {
    ...
    rangeLong: 9,
    salvo: 1,
    traits: ['Blast [Small]', 'Inflict (On Fire)', 'Pistol', 'Spread'],
    value: 5,
    rarity: 'Uncommon',
    keywords: ['FLAME', 'IMPERIUM'],
  },  
  'flamer': {
    name: 'Flamer',
    damage: '10',
    ...
    rangeLong: 12,
    salvo: 1,
    traits: ['Assault', 'Blast [Medium]', 'Inflict (On Fire)', 'Spread'],
    value: 5,
    rarity: 'Uncommon',
    keywords: ['FLAME', 'IMPERIUM'],
  },  
  'heavy flamer': {
    ...
    rangeLong: 12,
    salvo: 2,
    traits: ['Blast [Large]', 'Inflict (On Fire)', 'Heavy [6]', 'Spread'],
    value: 5,
    rarity: 'Uncommon',
    keywords: ['FLAME', 'IMPERIUM'],
  },  
